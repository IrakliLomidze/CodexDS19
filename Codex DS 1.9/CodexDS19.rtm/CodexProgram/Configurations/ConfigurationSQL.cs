...
namespace ILG.Codex.CodexR4
{
    public partial class ConfigurationSQL : Form
    {
        ...
        private void ultraButton5_Click(object sender, EventArgs e)
        {
            ...
            if (SQLServerConfigurationStatic.Default.CodexDS_DefaultDB != "") CatalogName_CodexR4 = SQLServerConfigurationStatic.Default.CodexDS_DefaultDB.Trim();
        ...
        static public void generateconnectionstring(int pSQLServerType)
        {
            ...
            if (SQLServerConfigurationStatic.Default.CodexDS_DefaultDB != "") CatalogName_CodexDS = SQLServerConfigurationStatic.Default.CodexDS_DefaultDB.Trim();
       ...
       public bool isconnectionParticularDatabase(String ConnectionString, String ConnectionStringName, String DatabaseName,  ref bool isCanceled )
        ...
        public bool isconnecting()
        {
            ...
            while (isconnectionParticularDatabase(SQLConnectionStrings.Default.ConnectionString_CodexDS, "ConnectionStringDS", CatalogName_CodexDS, ref isCanceled) == false)
            {
