    ...
    public partial class ConfigurationUI : Form
    {
        ...
        static public void load()
        {
                            ...
                            )
            {
                ...
                Properties.Settings.Default.MaximumDocListCodex = (uint)DSBehaviorConfiguration.Instance.content.General.AppMaxCodList;
            }
            ...
            if ((DSBehaviorConfiguration.Instance.content.General.IsKeyboard == true) &&
                (DSBehaviorConfiguration.Instance.content.General.AppKeyboardLayout >= 0) && (global::ILG.Codex.CodexR4.Properties.Settings.Default.AppKeyboardLayout < 5))
            {
                Properties.Settings.Default.KeyboardLayout = (uint)global::ILG.Codex.CodexR4.Properties.Settings.Default.AppKeyboardLayout;
            }
