    ...
    public partial class ErrorReport : Form
    {
      ...
      public String _String;
        ...
        private void ErrorReport_Load(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.WhenCrashNew = DSBehaviorConfiguration.Instance.content.General.WhenCrash;
            if (Properties.Settings.Default.WhenCrashNew == 0) Reboot_Check.Checked = false;
            if (Properties.Settings.Default.WhenCrashNew == 1) Reboot_Check.Checked = true;
