...
namespace ILG.Codex.CodexR4
{
    partial class Form1
    {
            ...
            using (new WaitCursor())
            {
                ...
                if (File.Exists(FavoritesFileNameFull) == true)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        string FavoritesFileBackp = $"CodexDS19.Favorites.XML.{DateTime.Now.Ticks.ToString()}.Backup";
        ...
        private void SaveTreeData()
        {
            ...
            using (new WaitCursor())
            {
                string _filename = "CodexDS19.Favorites.XML";
...
//===================================================================================================================
        ...
        private void SaveHistoryData()
        {
            using (new WaitCursor())
            {
                string _filename = "CodexDS19.History.xml"; 
       ...
       private void LoadHistoryData()
        {
            ...
            { FavoritesFile = "CodexDS19.History.xml"; }
            ...
            if (File.Exists(s1) == true)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    string HistoryFileBackp = $"CodexDS19.History.XML.{DateTime.Now.Ticks.ToString()}.Backup";
